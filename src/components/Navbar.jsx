...
import Logo from "../assets/hanko1.jpg";
...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#F7EFE3] text-gray-700">
      <div>
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : "absolute top-0 left-0 w-full h-screen bg-[#F7EFE3] flex flex-col justify-center items-center"
        }
      >
